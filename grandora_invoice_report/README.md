...
- **Default customer invoice print** — opens the US Letter (8.5 × 11 in) inkjet form for the pre-printed stationery. It prints invoice/delivery field labels and values, up to 19 invoice lines, totals, remarks, and delivery details at the calibrated positions; the physical form supplies all borders, artwork, and footer labels.
